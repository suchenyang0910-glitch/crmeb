...
//        }
    ...
    public function productDetail(Request $request, int $id, int $type)
    {
        ...
        $storeInfo = normalize_loopback_url($storeInfo, $request->domain());
        ...
        $productAttr = normalize_loopback_url($productAttr, $request->domain());
        $productValue = normalize_loopback_url($productValue, $request->domain());
        $attrPics = [];
